...
const owner_flash_config_8 bad_flash_config_wrapped = {
    .header =
        {
            .tag = kTlvTagFlashConfig,
            .length =
                sizeof(owner_flash_config_8),
        },
};

const owner_flash_config_t &bad_flash_config =
    reinterpret_cast<const owner_flash_config_t &>(bad_flash_config_wrapped);
...
const owner_flash_info_config &info_config =
    reinterpret_cast<const owner_flash_info_config &>(
        info_config_wrapped);
